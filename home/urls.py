...
urlpatterns = [
    ...
    path(
        ...
        views.SchoolInfoCreateView.as_view(
            ...
            success_message="Administration Details Added",
        ),
    ...
    path(
        ...
        views.SchoolInfoUpdateView.as_view(
            ...
            form_class=AdministrationForm,
            template_name="home/forms/administration_form.html",
            success_message="Administration Details Updated",
        ),
    ...
    path(
        ...
        views.SchoolInfoDeleteView.as_view(
            ...
            success_message="Administration Details Deleted",
        ),
    ...
    path(
        ...
        views.SchoolInfoUpdateView.as_view(
            ...
            success_message="Admission Details Updated",
        ),
    ...
    path(
        ...
        views.SchoolInfoUpdateView.as_view(
            ...
            form_class=AcademicForm,
            template_name="home/forms/academic_form.html",
            success_message="Academic Details Updated",
        ),
    ...
    path(
        ...
        views.SchoolInfoDeleteView.as_view(
            model=Academic,
            # success_url=reverse_lazy("about"),
            success_message="Academic Details Deleted",
        ),
    ...
    path(
        ...
        views.SchoolInfoCreateView.as_view(
            ...
            success_message="Curricular Details Added",
        ),
    ...
    path(
        ...
        views.SchoolInfoUpdateView.as_view(
            ...
            form_class=CurricularForm,
            template_name="home/forms/curricular_form.html",
            success_message="Curricular Details Updated",
        ),
    ...
    path(
        ...
        views.SchoolInfoUpdateView.as_view(
            ...
            success_message="School History Details Updated",
        ),
    ...
    path(
        ...
        views.SchoolInfoUpdateView.as_view(
            ...
            success_message="School Values Details Updated",
        ),
