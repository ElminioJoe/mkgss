...
urlpatterns = [
    ...
    path('about/delete/administration/<int:pk>/', SchoolInfoDeleteView.as_view(model=Administration, success_url = reverse_lazy('about')), name='administration_delete'),
    ...
    path('about/delete/academic/<int:pk>/', SchoolInfoDeleteView.as_view(model=Academic, success_url = reverse_lazy('about')), name='academic_delete'),
    ...
    path('about/delete/curricular/<int:pk>/', SchoolInfoDeleteView.as_view(model=Curricular, success_url = reverse_lazy('about')), name='curricular_delete'),
    ...
    path('about/delete/staff/<int:pk>/', SchoolInfoDeleteView.as_view(model=Staff, success_url = reverse_lazy('about')), name='staff_delete'),
